...
#End Region
	...
	Dim faceBox As Boolean = True
	Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
		faceBox = False
	End Sub

	Private Sub FaceDelay_Tick(sender As Object, e As EventArgs) Handles FaceDelay.Tick
		Dim sw As New StreamWriter("C:\Users\Richard Voragen\Desktop\Judy\Words\UserName.txt")
	...
	Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
		...
		If facebox = True Then
			imageBoxFrameGrabber.Image = currentFrame
		End If
		label4.Text = names
		If addNew = False And names <> "" And names <> "," And names <> " ," And names <> ", " Then
			FaceDelay.Start()
		End If
		names = ""
